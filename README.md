...
<style>
.myButton {
    box-shadow: 0px 20px 14px -7px #9c9993;
...
.myButton:hover {
    background:linear-gradient(120deg, #5F8539, #ffdf1f, #D77020 );
...
<a href="https://saskiaotto.github.io/INDperform/" class="myButton">INDperform
website</a>
